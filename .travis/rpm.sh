#!/bin/bash
#
# RPM build wrapper for ocaml-sexplib0, runs inside the build container on travis-ci
...
chown root:root ocaml-sexplib0.spec

build-rpm-package.sh ocaml-sexplib0.spec
